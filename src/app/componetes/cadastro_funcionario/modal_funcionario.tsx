...
import { buscarFuncionarios } from "@/app/api/funcionarios/utils/BuscarFuncionario";
    ...
    async function carregarAlojamento(){
        ...
        console.log("Alojamentos carregados:", data);
        setAloj(data)
   ...
   useEffect(() => {
    ...
    return (
        <div className="modal_func">
            ...
            <div className="bg-gray-800 text-white p-6 rounded-lg shadow-xl w-[700px] h-[550px] overflow-y-auto">
                {/* Cabeçalho */}
                ...
                <div>
                    ...
                    />
                    {erros.cpf && (
                    <p className="text-red-400 text-sm mt-1">{erros.cpf}</p>
                    )}
                </div>
                ...
                <div>
                    ...
                    {erros.turno && (
                    <p className="text-red-400 text-sm mt-1">{erros.turno}</p>
                    )}
                </div>
                ...
                <div>
                    ...
                    {Aloj.length === 0 ? (
                        <option disabled>Nenhum alojamento encontrado</option>
                        ) : (
                        Aloj.map((aloj) => (
                            <option key={aloj.id} value={aloj.alojamento}>
                            {aloj.alojamento}
                            </option>
                        ))
                        )}
                    ...
                    {erros.alojamento && (
                    <p className="text-red-400 text-sm mt-1">{erros.alojamento}</p>
                    )}
                </div>
